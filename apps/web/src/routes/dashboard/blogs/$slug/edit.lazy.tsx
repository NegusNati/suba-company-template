...
const routeApi = getRouteApi("/dashboard/blogs/$slug/edit");

export const Route = createLazyFileRoute("/dashboard/blogs/$slug/edit")({
...
function RouteComponent() {
  ...
  return <BlogDetail blogId={data.id} mode="edit" />;
}
