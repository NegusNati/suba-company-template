...
export const Columns = (
  onView: (clientProject: ClientProject) => void,
  onEdit: (clientProject: ClientProject) => void,
  onDelete: (clientProject: ClientProject) => void,
): ColumnDef<ClientProject>[] => [
  {
    accessorKey: "id",
    meta: {
      title: "Id",
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const client = row.getValue("client") as ClientProject["client"];
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const service = row.getValue("service") as ClientProject["service"];
      return (
        <div className="max-w-[200px] truncate">
          {service ? (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const tags = row.getValue("tags") as ClientProject["tags"];
      return (
  ...
  },
  {
    ...
    cell: ({ row }) => {
      const images = row.getValue("images") as ClientProject["images"];
  ...
  },
  {
    ...
    header: "Action",
    cell: ({ row }) => {
      const clientProject = row.original;
        ...
        <div className="flex justify-end">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => onView(clientProject)}>
                <Eye className="mr-2 h-4 w-4" />
                View
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => onEdit(clientProject)}>
                <Pencil className="mr-2 h-4 w-4" />
                Edit{" "}
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => onDelete(clientProject)}>
